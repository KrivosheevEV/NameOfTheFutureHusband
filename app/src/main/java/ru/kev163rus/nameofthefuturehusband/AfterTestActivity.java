...
import ru.kev163rus.nameofthefuturehusband.FinishActivity;
    ...
    public void onClick(View v) {
        ...
        Appodeal.setNonSkippableVideoCallbacks(new NonSkippableVideoCallbacks() {
            ...
            public void onNonSkippableVideoLoaded() {
                if (AccessoryClass.isDebuging) showToast("onNonSkippableLoaded");
            }

            @Override
            public void onNonSkippableVideoFailedToLoad() {
                if (AccessoryClass.isDebuging) showToast("onNonSkippableFailedToLoad");
//                finish();
//                startActivity(new Intent(AfterTestActivity.this, FinishActivity.class));
            }
            ...
            public void onNonSkippableVideoShown() {
                if (AccessoryClass.isDebuging) showToast("onNonSkippableShown");
//                finish();
//                startActivity(new Intent(AfterTestActivity.this, FinishActivity.class));
            }
            ...
            public void onNonSkippableVideoFinished() {
                if (AccessoryClass.isDebuging) showToast("onNonSkippableClicked");

            }

            @Override
            public void onNonSkippableVideoClosed() {
                if (AccessoryClass.isDebuging) showToast("onNonSkippableClosed");
                finish();
                startActivity(new Intent(AfterTestActivity.this, FinishActivity.class));
            }
        ...
        Appodeal.setInterstitialCallbacks(new InterstitialCallbacks() {
            ...
            public void onInterstitialLoaded(boolean isPrecache)  {
                if (AccessoryClass.isDebuging) showToast("onInterstitialLoaded");
            }

            @Override
            public void onInterstitialFailedToLoad() {
                if (AccessoryClass.isDebuging) showToast("onInterstitialFailedToLoad");

            }

            @Override
            public void onInterstitialShown() {
                if (AccessoryClass.isDebuging) showToast("onInterstitialShown");
//                finish();
//                startActivity(new Intent(AfterTestActivity.this, FinishActivity.class));
            }
            ...
            public void onInterstitialClicked() {
                if (AccessoryClass.isDebuging) showToast("onInterstitialClicked");
                //startActivity(new Intent(AfterTestActivity.this, FinishActivity.class));
            }

            @Override
            public void onInterstitialClosed() {
                if (AccessoryClass.isDebuging) showToast("onInterstitialClosed");
                finish();
                startActivity(new Intent(AfterTestActivity.this, FinishActivity.class));
            }
