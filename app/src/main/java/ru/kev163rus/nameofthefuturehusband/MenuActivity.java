...
import ru.kev163rus.nameofthefuturehusband.AccessoryClass;
import ru.kev163rus.nameofthefuturehusband.BeforeTestActivity;
import ru.kev163rus.nameofthefuturehusband.R;
...
//        mTimer.schedule(mMyTimerTask, 300, 2000);
    ...
    private void resetData(){
        AccessoryClass.indexOfQuestion = 1;
        AccessoryClass.itFastTest = false;
        AccessoryClass.itFullTest = false;
        AccessoryClass.itAddTest = false;
        AccessoryClass.arrayUserResult = null;
        AccessoryClass.arrayOfNumQuestions = null;
    }
    ...
    private void setData(String itemMenu){
        ...
        switch (itemMenu){
            case "Fast":
                AccessoryClass.itFastTest = true;
                AccessoryClass.countOfQuestions = 10;
                AccessoryClass.fillArrayOfNumQuestions(AccessoryClass.countOfQuestions);
                break;
            case "Full":
                AccessoryClass.itFullTest = true;
                AccessoryClass.countOfQuestions = 25;
                AccessoryClass.fillArrayOfNumQuestions(AccessoryClass.countOfQuestions);
                break;
            case "Add":
                AccessoryClass.itAddTest = true;
                AccessoryClass.countOfQuestions = 0;
                AccessoryClass.fillArrayOfNumQuestions(AccessoryClass.countOfQuestions);
                break;
            default:
                AccessoryClass.itFastTest = true;
        ...
        AccessoryClass.arrayUserResult = new int[AccessoryClass.countOfQuestions];
